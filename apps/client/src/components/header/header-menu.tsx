...
export const HeaderMenu = () => {
  ...
  return (
    <Menu position="bottom-end" keepMountedMode="display-none">
      <Menu.Target>
      ...
      <Menu.Dropdown miw={250}>
        ...
        <Anchor component={Link} to="/settings" underline="never">
          <Menu.Item leftSection={<Iconify icon="@vite:solar:settings-bold" />}>Settings</Menu.Item>
        </Anchor>
        <MoreInfoMenu />
        <Menu.Divider />
        <Logout>
...
const MoreInfoMenu = () => {
  return (
    <Menu.Sub position="bottom-end" offset={10} closeDelay={200}>
      <Menu.Sub.Target>
        <Menu.Sub.Item leftSection={<Iconify icon="@vite:solar:info-circle-bold" />}>
          More Info
        </Menu.Sub.Item>
      </Menu.Sub.Target>
      <Menu.Sub.Dropdown>
        <Anchor component={Link} to="/about" underline="never">
          <Menu.Item leftSection={<Iconify icon="@vite:solar:info-circle-bold" />}>About</Menu.Item>
        </Anchor>
        <Menu.Divider />
        <ShortcutsToggle />
        <Anchor href="https://voltanet.github.io" target="_blank" underline="never">
          <Menu.Item leftSection={<Iconify icon="@vite:solar:book-bold" />}>
            Documentation
          </Menu.Item>
        </Anchor>
        <Anchor href="https://github.com/voltanet/voltanet" target="_blank" underline="never">
          <Menu.Item leftSection={<Iconify icon="@vite:solar:code-bold" />}>Source Code</Menu.Item>
        </Anchor>
      </Menu.Sub.Dropdown>
    </Menu.Sub>
  );
